...
describe('UpdateCategoryBudgetTool', () => {
    ...
    it('should update category budgeting successfully', async () => {
        ...
        expect(mockApi.categories.updateMonthCategory).toHaveBeenCalledWith('test-budget', '2025-01-01', 'cat-1', { category: { budgeted: 50000 } });
    ...
    it('should handle zero gracefully', async () => {
        ...
        const result = await tool.execute(input);
        expect(mockApi.categories.updateMonthCategory).toHaveBeenCalledWith('test-budget', '2025-01-01', 'cat-1', { category: { budgeted: 0 } });
    ...
    it('should handle large amounts (e.g. 1000)', async () => {
        ...
        const result = await tool.execute(input);
        expect(mockApi.categories.updateMonthCategory).toHaveBeenCalledWith('test-budget', '2025-01-01', 'cat-1', { category: { budgeted: 1000000 } });
