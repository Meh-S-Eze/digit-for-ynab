 ...
 */
class UpdateSingleTransactionTool extends SerializingMCPTool {
    ...
    schema = {
        budgetId: z
            .string()
            .describe("REQUIRED: The ID of the budget containing this transaction. Get from list_budgets()."),
        transactionId: z
            .string()
            .describe("REQUIRED: The ID of the transaction to update. Get from analyze_transactions()."),
        accountId: z
            .string()
            .optional()
            .describe("Update the account this transaction belongs to. Get from list_accounts()."),
        date: z
            .string()
            .regex(/^\d{4}-\d{2}-\d{2}$/)
            .optional()
        ...
        amount: z
            .number()
            .optional()
            .describe("Update the amount in dollars. Negative = expense (e.g., -10.99), Positive = income (e.g., 1000.00)."),
        payeeName: z
            .string()
            .nullable()
            .optional()
        ...
        payeeId: z
            ...
            .nullable()
            .optional()
            .describe("Update by payee ID. Get from get_payees() or analyze_transactions()."),
        categoryId: z
            .string()
            .nullable()
            .optional()
            .describe("Update the category. Get from get_month_detail(). Use empty string to remove category."),
        memo: z
            .string()
            .nullable()
            .optional()
        ...
        cleared: z
            ...
            .optional()
            .describe("Update the cleared status: 'cleared', 'uncleared', or 'reconciled'."),
        approved: z
            .boolean()
            .optional()
            .describe("Update whether transaction is approved. Use approve_transaction() for easier approval."),
        flagColor: z
            .string()
            .nullable()
            .optional()
            .describe("Update the flag color (e.g., 'red', 'orange', 'yellow', 'green', 'blue', 'purple')."),
    };
    api;
    constructor() {
        super();
