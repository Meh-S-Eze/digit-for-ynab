 ...
 */
class UpdateCategoryBudgetTool extends SerializingMCPTool {
    ...
    async executeInternal(input) {
        ...
        try {
            ...
            const response = await this.api.categories.updateMonthCategory(budgetId, input.month, input.categoryId, data);
