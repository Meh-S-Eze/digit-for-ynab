...
class GetPayeesTool extends MCPTool {
    name = "get_payees";
    description = "Get a list of all payees for a specified budget";
    schema = {
        budgetId: {
            type: z.string().optional(),
            description: "The ID of the budget to get payees for (optional, defaults to the budget set in the YNAB_BUDGET_ID environment variable)",
        },
    };
    api;
    budgetId;
