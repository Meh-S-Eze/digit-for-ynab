...
class ListAccountsTool extends MCPTool<ListAccountsInput> {
  ...
  schema = {
    budgetId: {
      ...
      description:
        "The ID of the budget (optional, defaults to env var YNAB_BUDGET_ID). Get this from list_budgets.",
    },
  };
  ...
  async execute(input: ListAccountsInput): Promise<ListAccountsResult | string> {
