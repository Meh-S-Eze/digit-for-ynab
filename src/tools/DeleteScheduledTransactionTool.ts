 ...
 * - Cannot be undone
 */
class DeleteScheduledTransactionTool extends MCPTool<DeleteScheduledTransactionInput> {
    ...
    async execute(input: DeleteScheduledTransactionInput): Promise<DeleteScheduledResult | string> {
