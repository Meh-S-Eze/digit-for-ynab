...
class ToolMatrixPrompt extends MCPPrompt {
    name = "tool_matrix";
    description = "Structured metadata for all YNAB MCP tools, including prerequisites and error recovery.";
...
export default ToolMatrixPrompt;
